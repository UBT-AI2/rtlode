...
class Solver:
    def __init__(self, config, buffer_size):
        ...
        """
        self._config = config
        self._system_size = len(config['components'])
    ...
    def input_full(self) -> bool:
        ...
        """
        input_data_size = len(data_desc.get_input_desc(self._system_size))
    ...
    def fetch_output(self) -> Dict:
        ...
        """
        output_data_size = len(data_desc.get_output_desc(self._system_size))
